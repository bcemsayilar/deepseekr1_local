...
# Use a wide layout for a cleaner, more spacious UI
st.set_page_config(
...
def page():
    ...
    st.title("RAG with Local DeepSeek R1")
    st.markdown("Upload a PDF, then ask questions about its contents. The system retrieves relevant chunks and provides concise answers.")
    ...
    with col_chat:
        ...
        display_messages()
        st.text_input("Type your question and press Enter", key="user_input", on_change=process_input)
